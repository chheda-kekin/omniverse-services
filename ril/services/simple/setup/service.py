...
router = ServiceAPIRouter(tags=["Simple Service Extension"])
...
async def generate_cube(cube_data: CubeDataModel):
    print("[ril.services.simple.setup] generate_cube was called")
    ...
    msg = f"[ril.services.simple.setup] Wrote a cube to this path: {asset_file_path}"
    print(msg)
    return msg


@router.get("/ping", summary="Simple ping response", description="An endpoint to get response to ping request")
